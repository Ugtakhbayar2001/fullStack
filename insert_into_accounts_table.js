...
const dbCon = mysql.createConnection({
    ...
    user: "C4131DF23U4",               // replace with the database user provided to you
    password: "66",                  // replace with the database password provided to you
    database: "C4131DF23U4",           // replace with the database user provided to you
    port: 3306
});
